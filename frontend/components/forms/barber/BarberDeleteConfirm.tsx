...
export default function BarberDeleteConfirm({ id, name, onSuccess, onCancel }: DeleteConfirmProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert(errData.error || "Gagal menghapus barber");
      }
    } catch (err) {
  ...
  return (
    <div className={styles.form}>
      <p>Apakah Anda yakin ingin menghapus barber <strong>{name}</strong>?</p>
